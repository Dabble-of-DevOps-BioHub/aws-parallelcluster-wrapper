...
coverage: ## check code coverage quickly with the default Python
	coverage run --source aws_parallelcluster_wrapper setup.py test
	coverage report -m
	coverage html
	$(BROWSER) htmlcov/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/aws_parallelcluster_wrapper.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ aws_parallelcluster_wrapper
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
